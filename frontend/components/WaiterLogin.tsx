...
export const WaiterLogin: React.FC<Props> = ({ onBack, onLogin }) => {
    ...
    <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-500">
      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden">
        <div className="p-8 sm:p-12 text-center">
          <div className="w-20 h-20 bg-orange-50 rounded-2xl flex items-center justify-center mx-auto mb-6 text-orange-600">
          ...
          <h1 className="text-2xl font-bold text-slate-900 mb-2">Login Garçom</h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all outline-none"
                  value={username}
          ...
          <p className="mt-8 text-xs text-slate-400">
            Problemas com o acesso? Procure o gerente do estabelecimento.
          </p>
        </div>
      </div>
    </div>
